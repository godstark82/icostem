...
export default function Programme() {
    return (
        <>
        <div>
            <AboutHeader title="Programme" date="5 - 7 September" image='/images/simdte-dark-lg.png' overlayColor='#1f1f33' bgImage='/images/calendar-imp-dates.png' dividerColor='secondary' />
        </div>
